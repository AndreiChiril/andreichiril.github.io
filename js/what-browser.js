...
if (isOpera == true) {
	...
	var whattoshow = uuse + "Chrome or a Chromium browser. <a href='https://www.zdnet.com/pictures/all-the-chromium-based-browsers/'>See the list of Chromium browsers.</a>"
} else {
